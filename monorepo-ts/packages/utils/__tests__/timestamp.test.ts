...
describe('TimestampGenerator', () => {
    ...
    describe('fromDate', () => {
        ...
        it('should generate timestamp from date in milliseconds format', () => {
            const result = TimestampGenerator.fromDate(
                testDate,
                {
                    format: 'milliseconds',
                }
...
describe('TimestampConverter', () => {
    describe('fromUnix', () => {
        it('should convert unix timestamp to Date', () => {
            ...
            const result =
                TimestampConverter.fromUnix(unixTimestamp);
        ...
        it('should handle negative timestamp', () => {
            const result =
                TimestampConverter.fromUnix(-86400);
            expect(result.toISOString()).toBe(
    ...
    describe('fromMilliseconds', () => {
        it('should convert milliseconds timestamp to Date', () => {
            ...
            const result =
                TimestampConverter.fromMilliseconds(
                    millisTimestamp
                );
            expect(result).toBeInstanceOf(Date);
        ...
        it('should handle zero timestamp', () => {
            const result =
                TimestampConverter.fromMilliseconds(0);
            expect(result.toISOString()).toBe(
                '1970-01-01T00:00:00.000Z'
            );
        });
    ...
    describe('fromISO', () => {
        it('should convert ISO string to Date', () => {
            ...
            const result =
                TimestampConverter.fromISO(isoString);
            expect(result).toBeInstanceOf(Date);
            expect(result.getTime()).toBe(1686832245123);
        ...
        it('should handle invalid ISO string', () => {
            const result =
                TimestampConverter.fromISO('invalid-date');
...
describe('Edge cases and error handling', () => {
    ...
    it('should handle fractional unix timestamps', () => {
        ...
        const date =
            TimestampConverter.fromUnix(fractionalUnix);
