...
export function DashboardProvider({ config, children }: DashboardProviderProps) {
  ...
  const enablePlugin = useCallback((pluginId: string) => {
    setActivePlugins((prev) => {
      ...
      return [...prev, { id: pluginId, enabled: true }];
    });
  }, []);
    ...
    <DashboardContext.Provider value={contextValue}>
      <div
        style={{
          ...
          // Dark mode colors
          '--dashboard-dark-primary': theme.darkColors?.primary || theme.colors.primary,
          '--dashboard-dark-secondary': theme.darkColors?.secondary || theme.colors.secondary,
          '--dashboard-dark-background': theme.darkColors?.background || theme.colors.background,
          '--dashboard-dark-surface': theme.darkColors?.surface || theme.colors.surface,
          '--dashboard-dark-text': theme.darkColors?.text || theme.colors.text,
          '--dashboard-dark-text-secondary': theme.darkColors?.textSecondary || theme.colors.textSecondary,
          '--dashboard-dark-border': theme.darkColors?.border || theme.colors.border,
