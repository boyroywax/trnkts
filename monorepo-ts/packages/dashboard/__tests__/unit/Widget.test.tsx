...
describe('Widget Component', () => {
    ...
    it('renders with config prop', () => {
        ...
        expect(
            screen.getByText('Configured Widget')
        ).toBeInTheDocument();
        expect(
            screen.getByText('Configured content')
        ).toBeInTheDocument();
    });
    ...
    it('has proper structure with title and content sections', () => {
        ...
        const contentElement = widget.querySelector(
            'div:last-child'
        );
    ...
    it('renders complex children correctly', () => {
        ...
        expect(
            screen.getByText('Complex Widget')
        ).toBeInTheDocument();
        expect(
            screen.getByText('Nested Title')
        ).toBeInTheDocument();
        expect(
            screen.getByText('Some paragraph text')
        ).toBeInTheDocument();
        expect(
