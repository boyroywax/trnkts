...
describe('SidebarItem Component', () => {
  ...
  it('calls onClick when clicked', () => {
    ...
    render(<SidebarItem title="Clickable Item" onClick={mockOnClick} />);
  ...
  it('applies active styles when isActive is true', () => {
    const { container } = render(<SidebarItem title="Active Item" isActive={true} />);
  ...
  it('applies custom className', () => {
    ...
    const { container } = render(<SidebarItem title="Test" className={customClass} />);
