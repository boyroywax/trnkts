...
const web3Icons = {
    'bitcoin': {
        ...
        paths: [
            ...
            // Inner circle for layering
            'M12 3C7.03 3 3 7.03 3 12s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9z',
            // Bitcoin B symbol
            'M10.5 8.5V7h1v1.5h1V7h1v1.5c.83 0 1.5.67 1.5 1.5 0 .33-.11.63-.29.87.18.24.29.54.29.87 0 .83-.67 1.5-1.5 1.5V15h-1v-1.5h-1V15h-1v-1.5H9V12h1.5V10H9V8.5h1.5z',
            'M11.5 10v1h2c.28 0 .5-.22.5-.5s-.22-.5-.5-.5h-2z',
            'M11.5 12v1h2.5c.28 0 .5-.22.5-.5s-.22-.5-.5-.5h-2.5z'
        ]
    },
    'ethereum': {
        name: 'Ethereum',
